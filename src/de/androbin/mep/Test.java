...
public final class Test {
  ...
  public static boolean query( final MathContext context ) {
    final String expression = JOptionPane.showInputDialog(
        null, "Please enter expression:", TITLE, JOptionPane.PLAIN_MESSAGE );
    
    if ( expression == null || expression.trim().isEmpty() ) {
      return false;
    } else {
      JOptionPane.showMessageDialog( null, "The expression evaluates to '"
          + MEP.parseTerm( context, expression ).evaluate( context ).toString() + "'",
